  ...
  const plans = [
    {
      ...
      buttonStyle:
        "bg-gray-700 text-white hover:bg-gradient-to-r hover:from-purple-700 hover:to-orange-600",
      badge: null,
    ...
    },
    {
      ...
      buttonStyle:
        "bg-gradient-to-r from-purple-700 to-orange-600 text-white hover:from-purple-800 hover:to-orange-700",
    ...
    },
    {
      ...
      isCustom: true,
      features: [
        { text: "Tailored pricing based on your requirements", included: true },
        { text: "Personalized consultation", included: true },
        { text: "Custom features and integrations", included: true },
    ...
    <section ref={sectionRef} className="text-white py-20">
      <div className="container mx-auto px-4">
        ...
        {isMobile ? (
          ...
          <div className="overflow-x-auto pb-4 hide-scrollbar">
            <div className="flex gap-6 px-4" style={{ width: `${plans.length * 280}px` }}>
              {plans.map((plan, index) => (
                <div
                  className="relative bg-gray-900/50 border border-gray-800 rounded-2xl p-8 hover:bg-gray-800/50 transition-all duration-300 flex-shrink-0 w-64 h-full"
                >
                  {/* Badge */}
                  {plan.badge && (
                    <div
                  ...
                  <div className="mb-8">
                    ...
                    {!plan.isCustom && isYearly && getSavings(plan) && (
          ...
          // Desktop grid - 3 cards in single row
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {plans.map((plan, index) => (
                <div
                  ...
                  className="relative bg-gray-900/50 border border-gray-800 rounded-2xl p-8 hover:bg-gray-800/50 transition-all duration-300 h-full"
                >
                  {/* Badge */}
                  {plan.badge && (
                    <div
