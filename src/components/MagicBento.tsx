    ...
    <>
      <style>
        {`
          ...
          @media (max-width: 599px) {
            ...
            .card-responsive .card .card__image {
              margin-bottom: 1rem;
            }
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-2">
          {(customData || cardData).map((card, index) => {
            ...
            if (enableStars) {
              return (
                ...
                >
                  {card.isLargeCard ? (
                    // Special layout for large cards: Title top, Image middle, Description bottom
                    <>
                      <div className="card__header flex justify-center relative text-white mb-4">
                        <h3
                          className={`card__title font-normal text-lg m-0 text-center ${
                      ...
                      <div className="card__image flex justify-center relative text-white mb-4 flex-1">
                        {card.label && card.label.includes(".") ? (
                          <img
                            src={card.label}
                            alt={card.title}
                            className="w-full max-w-[300px] h-36 object-contain"
                          />
                        ) : (
                    ...
                    // Regular layout for normal cards
                    <>
                      <div className="card__header flex justify-center gap-3 relative text-white mb-4">
                        {card.label && card.label.includes(".") ? (
                          <img
                            src={card.label}
                            alt={card.title}
                            className="w-full max-w-[250px] h-20 object-contain"
                          />
                        ) : (
                          <span className="card__label text-base">
                            {card.label}
